...
import presentation.route.user.insertUserActivity
...
//
    ...
    val userActivityRepositoryImpl: UserActivityRepository by inject()
    ...
    routing {
        ...
        getAllUserActivity(userActivityRepositoryImpl)
        insertUserActivity(userActivityRepositoryImpl)
